<%-- 
    ...
    Created on : 13/01/2022, 06:31:53 PM
    Author     : rodri
--%>
...
<html>
    ...
    <body style="background: #1b1f22;">
            ...
            <header id="header">
                ...
                <div class="content" id="content">
                    <div class="inner">
                        ...
                        <button type="button" name="btn_nuevoc" id="btn_nuevoc" class="btn btn-info btn-lg" onclick="LimpiarCategorias();">Nuevo</button>

                        <form action="servlet_categorias" method="POST" class="form-group">
                            <label>ID:</label>
                            <input type="text" name="txt_id_categorias" id="txt_id_categorias" class="form-control" value="0" readonly="">
                            <label for="lbl_categoria" ><b>Categoria</b></label>
                            <input type="text" name="txt_categoria" id="txt_categoria" class="form-control" placeholder="Ejemplo: Pepsi" onkeypress="return text(event);" required>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-header text-center">
                        ...
                        <h4 class="modal-title text-center">Lista de las Categorias </h4>
                        <form class="mr-sm-2">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <table class="table table-dark table-hover text-center">
                            ...
                            <tbody id="tbl_Categorias" style="color:white;">
                                <%           
                                    Categorias categoria=new Categorias();
                                    DefaultTableModel tabla = new DefaultTableModel();
                                    tabla = categoria.listadoDeCategorias();
                                    for (int t = 0; t < tabla.getRowCount(); t++) {
                                        out.println("<tr data-id_categorias=" + tabla.getValueAt(t, 0) + ">");
        ...
        <script type="text/javascript">
                                $('#tbl_Categorias').on('click', 'tr td', function (evt) {
                                    var target, id, categoria;
                                    target = $(event.target);
                                    $("#btn_modificar").show();
                                    $("#btn_eliminar").show();
                                    $("#btn_agregar").hide();
                                    id = target.parent().data("id_categorias");
                                    categoria = target.parent("tr").find("td").eq(0).html();

                                    $("#txt_id_categorias").val(id);
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#myInput").on("keyup", function () {
                    ...
                    $("#tbl_Categorias tr").filter(function () {
